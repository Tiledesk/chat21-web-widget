...
export const environment = {
  ...
  // globalRemoteJSSrc:"/environments/real_data/segment_script-dev.js",
  remoteConfig: true,
  // remoteConfigUrl: '/widget-config.json',
  remoteConfigUrl: '/environments/real_data/widget-config-aws-stage.json',
  // remoteConfigUrl: '/environments/real_data/widget-config-regione-puglia.json',
  // remoteConfigUrl: '/environments/real_data/widget-config-aws-aruba.json',
  ...
  logLevel: 'ERROR',
  firebaseConfig: {
    apiKey: 'AIzaSyC68bFG352UXXHrowP10tAcaJLtMcTOdVw',
